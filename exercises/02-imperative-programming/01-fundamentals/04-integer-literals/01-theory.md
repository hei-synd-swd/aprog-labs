...
The underscore `_` is a **digit separator** - it is ignored by the compiler and only improves readability:
...
All of these are just different *notations* for the same numbers. For example `0xFF`, `0b1111_1111`, `0o377`, and `255` all represent the value 255.
